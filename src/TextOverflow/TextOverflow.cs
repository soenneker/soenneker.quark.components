...
public static class TextOverflow
{
    ...
    /// </summary>
    public static TextOverflowBuilder Clip => new(Soenneker.Quark.Enums.TextOverflows.TextOverflow.Clip);

    /// <summary>
    /// Displays an ellipsis ('…') to represent clipped text.
    /// </summary>
    public static TextOverflowBuilder Ellipsis => new(Soenneker.Quark.Enums.TextOverflows.TextOverflow.Ellipsis);
